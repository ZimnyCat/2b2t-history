...
_actions = ["%1 использован как %2 на 2b2t", "Вся правда о %1 на 2b2t", "%1 выжил 24 часа на %2",
            ...
            "Как %1 уничтожил историю 2b2t", "Обновление 2b2t изменит %1 навсегда", "%1 объявляет ВОЙНУ на %2",
            "Как я нашёл мой собственный %1 на 2b2t", "Как %1 СЛОМАН на 2b2t", "Как найти 1% на 2b2t",
